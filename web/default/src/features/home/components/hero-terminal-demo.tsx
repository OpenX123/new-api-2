    ...
    <div className={cn('mx-auto w-full max-w-2xl', props.className)}>
      <div
        className={cn(
          ...
          'border-border bg-card shadow-[0_12px_28px_-22px_rgb(0_0_0_/_0.22)]',
      ...
      >
        ...
        >
          ...
          <div className='ml-auto flex items-center gap-2 pr-2 sm:pr-3'>
            <span className='bg-primary inline-block size-1.5 rounded-full shadow-[0_0_8px_color-mix(in_oklch,var(--primary)_55%,transparent)]' />
